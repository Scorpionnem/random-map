...
execute if score .players players matches 2.. run execute if score .starting game matches 1 if score .startingtimer game matches 60 run tellraw @a {"bold":true,"color":"green","italic":false,"text":"3"}
